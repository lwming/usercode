...
//// --------inputs--------------
      ...
      TString background_name = "ttbar_ll";
      TString fname1 = "inputTrees/March4/ttH125.root" ;
      TString fname2 = "inputTrees/March4/"+background_name+".root" ;
      TString fname3 = "inputTrees/March4/ttbar_cc_ll.root" ;
      TString fname4 = "inputTrees/March4/ttbar_bb_ll.root" ;
...
factory1->SetWeightExpression( "weight*topPtWgt" );
