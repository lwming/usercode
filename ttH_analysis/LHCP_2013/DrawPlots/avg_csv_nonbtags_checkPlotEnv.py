...
#	   print "ITERATOR: name = %s" % iplot.name
	   ...
	   if (iplot.name != "data_2012_53x"):
		   origHist.Scale(4616/4239.0)
	   origHist_JESUp = None
	   ...
	   if not skipSystematicsPG:
		   ...
		   constNorm =  origHist.Integral()
		   Norm_eff_bUp = origHist_eff_bUp.Integral()
		   Norm_eff_bDown = origHist_eff_bDown.Integral()
		   Norm_fake_bUp = origHist_fake_bUp.Integral()
		   Norm_fake_bDown = origHist_fake_bDown.Integral()
		   Norm_lfStats1Up = origHist_lfStats1Up.Integral()
		   Norm_lfStats1Down = origHist_lfStats1Down.Integral()	   
		   Norm_lfStats2Up = origHist_lfStats2Up.Integral()
		   Norm_lfStats2Down = origHist_lfStats2Down.Integral()	   
		   Norm_hfStats1Up = origHist_hfStats1Up.Integral()
		   Norm_hfStats1Down = origHist_hfStats1Down.Integral()	   
		   Norm_hfStats2Up = origHist_hfStats2Up.Integral()
		   Norm_hfStats2Down = origHist_hfStats2Down.Integral()	   
		   
		   if (Norm_eff_bUp !=0):
			   origHist_eff_bUp.Scale(constNorm/Norm_eff_bUp)
		   if (Norm_eff_bDown !=0):
			   origHist_eff_bDown.Scale(constNorm/Norm_eff_bDown)
		   if (Norm_fake_bUp !=0):
			   origHist_fake_bUp.Scale(constNorm/Norm_fake_bUp)
		   if (Norm_fake_bDown !=0):
			   origHist_fake_bDown.Scale(constNorm/Norm_fake_bDown)
		   if (Norm_lfStats1Up !=0):
			   origHist_lfStats1Up.Scale(constNorm/Norm_lfStats1Up)
		   if (Norm_lfStats1Down !=0):
			   origHist_lfStats1Down.Scale(constNorm/Norm_lfStats1Down)
		   if (Norm_lfStats2Up !=0):
			   origHist_lfStats2Up.Scale(constNorm/Norm_lfStats2Up)
		   if (Norm_lfStats2Down !=0):
			   origHist_lfStats2Down.Scale(constNorm/Norm_lfStats2Down)
		   if (Norm_hfStats1Up !=0):
			   origHist_hfStats1Up.Scale(constNorm/Norm_hfStats1Up)
		   if (Norm_hfStats1Down !=0):
			   origHist_hfStats1Down.Scale(constNorm/Norm_hfStats1Down)
		   if (Norm_hfStats2Up !=0):
			   origHist_hfStats2Up.Scale(constNorm/Norm_hfStats2Up)
		   if (Norm_hfStats2Down !=0):
			   origHist_hfStats2Down.Scale(constNorm/Norm_hfStats2Down)
...
#	 ratioHist.SetTitle(";;Data/MC")
	...
	ratioErrHist.SetMarkerSize(0.001)		
...
#	hist.SetBinError(1, math.sqrt(math.pow(sys_frac_err*binCont,2)+binSumW2+binALL_err_squared))
	hist.SetBinError(1, math.sqrt(binALL_err_squared))
...
#		hist.SetBinError(newBin, math.sqrt(math.pow(sys_frac_err*float(binCont),2)+binSumW2+binALL_err_squared))
		hist.SetBinError(newBin, math.sqrt(binALL_err_squared))
#		if (binErrors == "all" and newBin == 3):
...
#		hist.SetBinError(nBins, math.sqrt(math.pow(sys_frac_err*binCont,2)+binSumW2+binALL_err_squared))
		hist.SetBinError(nBins, math.sqrt(binALL_err_squared))	
