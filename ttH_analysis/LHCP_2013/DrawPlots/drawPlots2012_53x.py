...
#		drawStackPlot("BDTG_e3je2t", pg,  "BDT output", 10, -0.9, 0.8, lepselection, year, "draw")
		drawStackPlot("sum_pt", pg, "Sum p_{T}(lepton, jets) (GeV)", 10, 150, 750, lepselection, year, "draw")
...
#		drawStackPlot("sum_pt", pg, "p_{T}(l, jets) (GeV)", 10, 200, 1000, lepselection, year, "draw")
...
#		drawStackPlot("higgsLike_dijet_mass", pg, "higgsLike dijet mass (GeV)", 10, 60, 190, lepselection, year, "draw")
#		drawStackPlot("higgsLike_dijet_mass2", pg, "higgsLike dijet mass2 (GeV)", 10, 50, 250, lepselection, year, "draw")
		drawStackPlot("numJets", pg, "Number of jets", 4, 4, 8, lepselection,year, "draw")
...
#		drawStackPlot("third_jet_pt", pg, "3rd jet p_{T}", 20, 30, 210, lepselection,year, "draw")
#		drawStackPlot("third_jet_eta", pg, "3rd jet eta", numBins, -2.5, 2.5, lepselection, year, "draw")
#		drawStackPlot("fourth_jet_pt", pg, "4th jet p_{T}", 20, 30, 130, lepselection,year, "draw")
#		drawStackPlot("fourth_jet_eta", pg, "4th jet eta", numBins, -2.5, 2.5, lepselection, year, "draw")
...
#		drawStackPlot("min_dr_jets", pg, "min. #DeltaR(j, j)", 10, 0.5, 2.5, lepselection, year, "draw")
#		drawStackPlot("higgsLike_dijet_mass", pg, "higgsLike dijet mass (GeV)", 10, 60, 190, lepselection, year, "draw")
		drawStackPlot("higgsLike_dijet_mass2", pg, "Second m(jj,H) (GeV)", 10, 50, 250, lepselection, year, "draw")
#		drawStackPlot("higgsLike_dijet_mass2", pg, "higgsLike dijet mass2 (GeV)", 10, 50, 250, lepselection, year, "draw")
...
##	drawStackPlot("lep1Phi", pg, "lep1Phi", numBins, -pival, pival, lepselection, year, "draw")
