...
#include <algorithm>
  ...
  gStyle->SetOptStat(0);
  TString ofName = "csv_rwt_hf_IT_v2_JESDown.root";
...
//   TH1 * sourceHisto2a = (TH1*) summaryTree->Draw(varName2+" >> histTemp2a",nonttbar+lumi+"weight*(Xsec/nGen)*("+lepselection2+ " && "+trigselection+" && "+jetselection1b+")","");
  TH1 * sourceHisto3a = (TH1*) Tree2->Draw(varName1+" >> histTemp3a",nonttbar+lumi+"weight*topPtWgt*csvWgtlf*(Xsec/nGen)*("+lepselection2+ " && "+firstjetb + " && "+trigselection+" && "+jetselection2a+")","");
  TH1 * sourceHisto4a = (TH1*) Tree2->Draw(varName2+" >> histTemp4a",nonttbar+lumi+"weight*topPtWgt*csvWgtlf*(Xsec/nGen)*("+lepselection2+ " && "+secondjetb +" && "+trigselection+" && "+jetselection2b+")","");
  TH1 * sourceHisto5a = (TH1*) Tree2->Draw(varName1+" >> histTemp5a",nonttbar+lumi+"weight*topPtWgt*csvWgtlf*(Xsec/nGen)*("+lepselection2+ " && !"+firstjetb +" && "+trigselection+" && "+jetselection2a+")","");
  TH1 * sourceHisto6a = (TH1*) Tree2->Draw(varName2+" >> histTemp6a",nonttbar+lumi+"weight*topPtWgt*csvWgtlf*(Xsec/nGen)*("+lepselection2+ " && !"+secondjetb +" && "+trigselection+" && "+jetselection2b+")","");
...
//   hClone->Write();
  ...
  can1a->Print("itTech_v2/"+varName+"_"+plotName +"_JESDown.png");
