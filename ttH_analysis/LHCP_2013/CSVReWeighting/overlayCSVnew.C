...
#include <algorithm>
  ...
  gStyle->SetOptStat(0);
  TString ofName = "csv_rwt_hf_new_JESDown.root";
...
//   TString extraLabel = ""; //Systematic of the input trees; set to "JESDown_" for JESDown, etc.
...
//   etaBins.push_back("1.6");
  ...
  TFile * sourceFile2 = new TFile  ("/afs/crc.nd.edu/user/w/wluo1/LHCP_2013/CMSSW_5_3_8_patch1/src/BEAN/csvReWeighting_DIR/allMC_JESDown.root");
...
//   hClone->Write();
  ...
  can1a->Print(varName+"_"+plotName +"_JESDown.png");
