...
#include <algorithm>
  ...
  TString ofName = "csv_rwt_lf_testAA.root";
...
//     TString varName2 = "second_jet_eta"; //Variable which the scale factor is a function of
  ...
  TString varName = "mass_leplep"; //Variable which the scale factor is a function of
  TString varName1 = "mass_leplep"; //Variable which the scale factor is a function of
  TString varName2 = "mass_leplep"; //Variable which the scale factor is a function of
  }
...
//   //  Double_t xBins[13] = {30,40,50,60,70,80,100,120,160,210,260,320,800};
  ...
  double Xmin = 81; //Lower bound for x-axis
  double Xmax = 101; //Upper bound for x-axis
...
//   if (EfficiencySF) histTemp3->Divide(histTemp3,histTemp1);
  ...
  histTemp3->GetXaxis()->SetTitle("M_{lep,lep}");
  //MC
  sourceFile2->cd();
...
//   histTemp3a->Scale(Data_tagged/MC_tagged);
  ...
  histTemp3a->SetName(Form("csv_MC_zjets_Pt%i_Eta%i",iPt,iEta));
...
//   histTemp5a->Scale(Data_tagged/MC_tagged);
  ...
  histTemp5a->SetName(Form("csv_MC_zjetsbc_Pt%i_Eta%i",iPt,iEta));
...
//   }
  ...
  can1a->Print("testAA/"+varName+plotName +".png");
  can1a->Print("testAA/"+varName+plotName +".pdf");
