...
void correlation_plots_sys(bool rwt = true, TString catName = "e3je2t"){
...
//     Float_t lumi = 19450;
  ...
  for (int isam=0; isam<21; isam++){
    ...
    TString sample = htitle[isam];
      TString fileName = "/afs/crc.nd.edu/user/w/wluo1/LHCP_2013/CMSSW_5_3_8_patch1/src/BEAN/DrawPlots/bin/treeFiles/dilSummaryTrees" +sample + "_2012_53x_latest_JESDown_all.root";
      if (isam>17) fileName = "/afs/crc.nd.edu/user/w/wluo1/LHCP_2013/CMSSW_5_3_8_patch1/src/BEAN/DrawPlots/bin/treeFiles/dilSummaryTrees" +sample + "_2012_53x_latest_all.root";
