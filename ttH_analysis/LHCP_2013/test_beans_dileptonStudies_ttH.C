...
void test_beans_dileptonStudies_ttH( int maxNentries, string sampleName,  string iLabel ) {
  ...
  outFileName <<"batchBEAN/" << sampleName << "_" << iLabel << "/test_beans_v1_" << sampleName << "_" << iLabel << "_job_" << "ALL" << ".root";
...
//                                << "numLooseElectrons = " << numLooseElectrons << std::endl;
      ...
      if (nevents < 10 ){
        std::cout <<"INFO: JES = " << jes << " nEVENT = " << nevents <<std::endl;
      }
